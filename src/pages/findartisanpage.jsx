...
export default function ArtisanFind(){
  ...
  {({ open }) => (
    ...
    <div className='relative py-2 mx-auto mt-2 bg-gray-200 min-h-[40rem] h-screen max-w-7xl sm:px-6 lg:px-8 rounded-xl'>
    <div className='flex flex-col'>
      <h2 className='mx-auto mt-1 text-2xl font-bold'>Find Carpenters</h2>
      <div>
        <SearchBar/>
      </div>
    </div>

      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <header className="pt-3 bg-gray-200 shadow h-28">
          <div className="flex items-center justify-between px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <Button type="button" text="+ Top Up" style={{backgroundColor: "inherit", color: "green", boxShadow: 0}} onClick={toggleDepositPopup}/>
            <Button type="button" text="Withdraw" style={{backgroundColor: "lightgreen", color: "Black", boxShadow: 0}} onClick={toggleWithdrawalPopup}/>
